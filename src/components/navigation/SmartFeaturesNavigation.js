            ...
            >
              <CardContent sx={{ p: 1.5, '&:last-child': { pb: 1.5 } }}>
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                  <Box sx={{ color: feature.color, mr: 1 }}>{feature.icon}</Box>
      ...
      >
        <Box sx={{ p: 1 }}>
          ...
          {features.map(feature => (
            ...
            >
              <Box sx={{ color: feature.color, mr: 1.5 }}>{feature.icon}</Box>
      ...
      <Box sx={{ p: 2 }}>
        ...
        <List>
          {features.map(feature => (
            ...
            >
              <ListItemIcon sx={{ color: feature.color }}>{feature.icon}</ListItemIcon>
              <ListItemText
...
const SmartFeaturesNavigation = ({
  ...
  switch (variant) {
    case 'tabs':
      return <SmartFeaturesTabs currentPath={location.pathname} onTabChange={handleTabChange} />;
...
export { SmartFeaturesQuickAccess, SmartFeaturesTabs, SmartFeaturesFAB, SmartFeaturesDrawer };
