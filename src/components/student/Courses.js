...
import { Avatar, Box, Button, Container, Divider, InputAdornment, List, ListItem, ListItemAvatar, ListItemText, Paper, Tab, Tabs, TextField, Typography } from '@mui/material';
          ...
          <List className={classes.courseList}>
            {archivedCourses.map((course) => (
              <ListItem key={course.id} className={classes.courseListItem} component="button">
                ...
                <ListItemText primaryTypographyProps={{ component: "div" }} primary={course.name}
