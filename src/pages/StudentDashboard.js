        ...
        <CardContent sx={{ p: 3 }}>
          ...
          >
            <Box sx={{ flex: 1 }}>
              ...
              <Typography
                variant="body2"
                sx={{ color: 'text.secondary', lineHeight: 1.5, fontWeight: 400 }}
              >
                  ...
                  <List dense>
                    {dashboardData.recentGrades.map((grade, index) => (
                      <ListItem key={index} sx={{ px: 0 }}>
                        ...
                        />
                        <Chip label={grade.points} size="small" variant="outlined" />
                      </ListItem>
                    ))}
                  </List>
                </CardContent>
                  ...
                  >
                    ...
                    <TableCell>
                      <Chip
                        label={grade.grade}
                        sx={{
                          background: grade.grade.includes('A')
        ...
        <Grid size={{ xs: 12, sm: 4 }}>
          <Card
            sx={{
              ...
              borderRadius: 3,
              background:
                'linear-gradient(135deg, rgba(192, 132, 252, 0.15) 0%, rgba(192, 132, 252, 0.05) 100%)',
